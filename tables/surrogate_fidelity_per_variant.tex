\begin{table}
\caption{Per-variant CatBoost surrogate fidelity on the held-out 20\%. CV-max is the depth maximising 5-fold CV Spearman~$\rho$; Depth is the 1-SD parsimony pick actually used for the final model fit.}
