...
\textbf{limitations}
A natural extension of this work would compare explanation reliability across model classes, for instance, between a misspecified Naive Bayes and a correctly specified gradient boosting model, to test whether fidelity and stability are model-structure-dependent. This was outside scope given available data access
